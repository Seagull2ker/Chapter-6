...
public class DatabaseActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mWorkThread.start();
        mWorkHander = new WorkHander(mWorkThread.getLooper());//下面的内部类
    ...
    private void addData() {
        ...
        long newRowId = db.insert(FeedEntry.TABLE_NAME, null, values);//返回是否成功
...
//        // Specify arguments in placeholder order.
//        String[] selectionArgs1 = {"title1"};
//        // Issue SQL statement.
//        int deletedRows1 = db.delete(FeedEntry.TABLE_NAME, selection, selectionArgs1);
//        Log.i(TAG, "perform delete data, result:" + deletedRows1);
//
//        // Specify arguments in placeholder order.
//        String[] selectionArgs2 = {"title2"};
//        // Issue SQL statement.
//        int deletedRows2 = db.delete(FeedEntry.TABLE_NAME, selection, selectionArgs2);
//        Log.i(TAG, "perform delete data, result:" + deletedRows2);
//
//        // Specify arguments in placeholder order.
//        String[] selectionArgs3 = {"title3"};
//        // Issue SQL statement.
//        int deletedRows3 = db.delete(FeedEntry.TABLE_NAME, selection, selectionArgs3);
//        Log.i(TAG, "perform delete data, result:" + deletedRows3);
    }
